...
# Domain FSMO Roles
$DomainFSMO = $DNSRoot | ForEach-Object { Get-ADDomain -Identity $_ }  | 
...
####### Need a foreach loop for each sites info
...
#region Privileged Account Info 
...
$OrgManagement = (Get-ADGroupMember -Identity 'Organization Management' | 
    Select-Object -ExpandProperty SamAccountName) -join '<br/>'
